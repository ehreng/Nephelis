...
_Auto-generated 2026-07-13T17:09:32.353Z from mission data. Re-run: `npx tsx automation/scripts/press-kit.ts`_
...
While Mars dominates popular attention, Venus’s cloud deck offers near-Earth temperature and pressure, abundant solar energy, and gravity close to Earth’s. Nephelis is a small private team shipping a practical first step: a long-duration aerostat with imaging, atmospheric, and life-detection sensors, relayed via CubeSat-class communications — funded leanly (~$500,000 goal) compared to multi-million-dollar class missions.
...
| Target | Venus cloud layer ~50–60 km |
| Platform | Super-pressure balloon |
| Wet mass | ~400 kg class |
...
- **Balloon Engraving** — $100: Laser-etch your name onto the aerostat balloon of Cloudseeker.
- **DNA Capsule** — $500: Send a biological sample (hair/nail) in our inert time capsule.

Crew signal list and volunteer intake: https://www.nephelisindustries.com/#contribute · https://www.nephelisindustries.com/#funding
