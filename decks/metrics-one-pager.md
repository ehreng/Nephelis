...
_Auto-generated from `site/content/data/*` · 2026-08-11T18:21:30.201Z_  
...
| MCC phase | PRE-HARDWARE · target uncommitted — earliest class ~2030–2031+ if gates pass |
...
- [P1] Meta-loop first review (day 7–14 of Daily Mission operation) — _planned_ (2026-Q3)
...
- [P0] Critical design review (lite): drawings, BOMs, test plans signed — _planned_ (2029-Q1)
- [P0] Fabricate flight-intent balloon envelope + inflation hardware — _planned_ (2029-Q1)
- [P0] Fabricate gondola structure + instrument mounts — _planned_ (2029-Q1)
- [P0] Fabricate/procure heatshield + attachment hardware — _planned_ (2029-Q1)
- [P0] Integrate sensor suite into gondola (electrical + mechanical) — _planned_ (2029-Q1)
- [P0] Flight avionics board bring-up + sensor drivers — _planned_ (2029-Q1)
- [P1] Solar + battery power demo at expected float illumination — _planned_ (2029-Q1)
- [P0] Comms breadboard: packet radio / store-and-forward demo — _planned_ (2029-Q1)
- [P0] Baseline CubeSat relay (buy vs partner vs descoped direct link) — _planned_ (2029-Q1)
- [P0] Kick/transfer stage: make vs buy vs rideshare-provided Δv — _planned_ (2029-Q1)
- [P0] Hit 50% of $500k goal (cash + binding in-kind) — _planned_ (2029-Q1)
- [P1] Close first corporate / logo sponsorship above individual tiers — _planned_ (2029-Q1)
- [P1] Instrument calibration plan + ground truth datasets — _planned_ (2029-Q1)
- [P0] Environmental qualification plan signed (TVAC, vibe, shock, thermal) — _planned_ (2029-Q2)
- [P0] Vibration / shock test of integrated stack (or mass model path) — _planned_ (2029-Q2)
- [P0] Thermal-vacuum test of gondola/avionics (or chamber access partner) — _planned_ (2029-Q2)
- [P1] Cold / altitude-chamber or high-altitude balloon analog for envelope — _planned_ (2029-Q2)
- [P0] End-to-end system integration test: power → sensors → store → radio — _planned_ (2029-Q2)
- [P0] Full inflation sequence dry run on Earth (timed, instrumented) — _planned_ (2029-Q2)
- [P0] Flight software fault protection + safe modes verified on hardware — _planned_ (2029-Q2)
- [P0] Launch path LOI / rideshare reservation for 2030s Venus window class — _planned_ (2029-Q2)
- [P0] Sign launch broker or secondary payload agreement (or dedicated option) — _planned_ (2029-Q2)
- [P1] Range safety / payload ICD inputs for launch provider — _planned_ (2029-Q2)
- [P0] Hit 75% of funding goal before integration freeze — _planned_ (2029-Q2)
- [P1] Ground station / data downlink operations plan (partners or commercial) — _planned_ (2029-Q2)
- [P0] Flight software freeze + config management for flight load — _planned_ (2030-Q3)
- [P0] Ops playbook v1: entry through float daily comms windows — _planned_ (2030-Q3)
- [P0] Mission ops rehearsal (tabletop + sim): anomalies and contingencies — _planned_ (2030-Q3)
- [P0] Ship/flight prep: packing, hazardous materials, logistics to launch site — _planned_ (2030-Q3)
- [P1] Freeze Tier-1 engraving list + DNA capsule packing procedure — _planned_ (2030-Q3)
- [P1] Launch press kit + media list + embargo plan — _planned_ (2030-Q3)
- [P0] Close remaining funding / contingency reserve for launch ops — _planned_ (2030-Q3)
- [P0] Final acceptance test of flight stack before ship — _planned_ (2030-Q3)
- [P1] Independent red-team risk review (entry, inflate, comms, power) — _planned_ (2030-Q3)
- [P0] Launch campaign: integration with vehicle, checkouts, go/no-go — _planned_ (2030-Q4)
- [P0] Launch in 2030s Venus transfer window class — _planned_ (2030-Q4)
- [P0] Cruise operations: health checks, TCMs if any, instrument keep-alive — _planned_ (2030-Q4)
- [P0] Venus approach & entry ops: real-time decision tree execution — _planned_ (2031-Q1)
- [P0] Float operations day 1–30: science collection + daily downlink — _planned_ (2031-Q1)
- [P1] Extended float to 90 days if health allows — _planned_ (2031-Q2)
- [P0] Public data release #1 + mission report — _planned_ (2031-Q2)
- [P1] Lessons learned → Phase II larger aerostat / habitat tech roadmap — _planned_ (2031-Q2)
...
- **R-04** (high): No committed launch path; schedule risk is structural
- **R-05** (high): Capital shortfall vs flight-class cost
